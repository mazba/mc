                                        ...
                                        foreach($institute['date'] as $institite_class_date)
                                        {
                                            ...
                                            foreach($institite_class_date['class'] as $class)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                     //   echo Dashboard_helper::bn2enNumbermonth(date("F j, Y", strtotime($institite_class_date['class_date'])));
                                                        echo Dashboard_helper::bn2enNumbermonth($institite_class_date['class_date']);
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
