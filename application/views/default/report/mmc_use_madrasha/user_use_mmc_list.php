...
<div id="system_content" class="system_content_margin">
    ...
    <div class="col-lg-8">
        ...
        <form class="report_form" id="system_save_form" action="<?php echo $CI->get_encoded_url('report/mmc_use_madrasha/user_use_mmc_report/index/list'); ?>" method="get">
            <div class="row widget">
                ...
                <div class="row show-grid ">
                    ...
                    <div class="col-sm-8 col-xs-8">
                        ...
                        <div id="class_number" style="display: none">
                            <div style="display: block; clear: both">
                                <select name="class_number" id="class_number" class="form-control" style="width: 30%">
                                    <?php
                                    $ii=1;
                                    for($ii; $ii<13; $ii++){
