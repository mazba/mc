...
$high_chart_infozilla=Dashboard_helper::get_approved_institute_report_school_college('INTERMEDIATE', $from_date, $to_date, 'ASC');
//
//if($chart_infozilla):
//    $index=0;
//    $total_value=0;
...
//    $indexx=0;
//    foreach($high_chart_infozilla as $elementzillass1)
//    {
//echo $elementzillass1['element_name'].'-';
//         //   echo $element_name3 = Dashboard_helper::get_district_count_school_college($elementzillass1['element_name']).'--';
  ...
  <div class="col-lg-4">
	...
	<div class="col-lg-8">
	  <div class="widget-header">
					...
					{
						$report_caption= $CI->lang->line('LESS_SSC_HSC_MMC_DISTRICT_INSTITUTE');
					}
					...
					{
					$report_caption= $CI->lang->line('LESS_SSC_HSC_MMC_UPOZILLA_INSTITUTE');	
					}
					else{
					$report_caption= $CI->lang->line('LESS_SSC_HSC_MMC_INSTITUTE_INSTITUTE');	
					}
					?>
...
<form id="graphclass" action="<?php echo $CI->get_encoded_url('report/institute/mmcedu_level/school_college_less_mmc'); ?>" method="post">
