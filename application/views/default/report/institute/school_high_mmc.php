...
$high_chart_infozilla=Dashboard_helper::get_approved_institute_report('SECONDARY', $from_date, $to_date, 'ASC');
//
//if($chart_infozilla):
//    $index=0;
//    $total_value=0;
  ...
  <div class="col-lg-4">
	...
	<div class="col-lg-8">
	  <div class="widget-header">
                    <div class="title">
					অপেক্ষাকৃত অধিক পমাধ্যমিক শিক্ষা প্রতিষ্ঠান মাল্টিমিডিয়া ক্লাসরুম ব্যবহারকারী
...
<div class="constant">
<form id="graphclass" action="<?php echo $CI->get_encoded_url('report/institute/mmcedu_level/school_high_mmc'); ?>" method="post">
...
<script>
    $(function () {
        ...
        $('#containerzilla').highcharts({
            ...
            title: {
                text: '<?php //echo $report_caption;?> অপেক্ষাকৃত অধিক মাধ্যমিক শিক্ষা প্রতিষ্ঠান মাল্টিমিডিয়া ক্লাসরুম ব্যবহারকারী  ১০ জেলা। <?php echo Dashboard_helper::bn2enNumbermonth(date("F j, Y", strtotime($from_date)));?> থেকে  <?php echo Dashboard_helper::bn2enNumbermonth(date("F j, Y", strtotime($to_date)));?>'
            },
