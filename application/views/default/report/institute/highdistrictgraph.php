  ...
  <div class="col-lg-4">
	 ...
	 <div class="col-lg-8">
	  <div class="widget-header">
                    <div class="title">
                        অপেক্ষাকৃত অধিক মাল্টিমিডিয়া ক্লাসরুম ব্যবহারকারী 
                    </div>
    ...
    <form id="graphclass" action="<?php echo $CI->get_encoded_url('report/institute/highdistrictgraph'); ?>" method="post">
    ...
    $high_chart_infozilla=Dashboard_helper::get_approved_institute_listzilla($from_date, $to_date);
...
<script>
    $(function () {
        ...
        $('#containerzilla').highcharts({
            ...
            title: {
                text: '<?php //echo $report_caption;?>  অপেক্ষাকৃত অধিক মাল্টিমিডিয়া ক্লাসরুম ব্যবহারকারী । <?php echo Dashboard_helper::bn2enNumbermonth(date("F j, Y", strtotime($from_date)));?> থেকে  <?php echo Dashboard_helper::bn2enNumbermonth(date("F j, Y", strtotime($to_date)));?>'
            },
            ...
            tooltip: {
                formatter: function() {
                    return this.x +' '+ this.series.name+ '  এর মোট এম এম সি ব্যবহৃত শিক্ষা পাঠদান ' + this.y;
                }
            },
            series:
                [
