...
<div id="system_content">
    ...
    <div id="system_content" class="dashboard-wrapper">
        <div class="grid_10">
            ...
            <form action="<?php echo $CI->get_encoded_url('user_management/user_password_reset/index/list'); ?>"
                  class="signup" method="post" accept-charset="utf-8" enctype="multipart/form-data"
                  id="frm_user_approval">
                <div class="row widget">
                    <div class="widget-header">
                        <div class="title">
                            <?php echo $this->lang->line('USER_SEARCH_PASSWORD'); ?>
                        </div>
                    ...
                    <div class="row show-grid ">
                        <div class="col-xs-4">
                            <label
                                class="control-label pull-right"><?php echo $CI->lang->line('SCHOOL_EMAIL'); ?></label>
                        </div>
                        <div class="col-sm-4 col-xs-8">
                            <input type="text" name="user_id" class="selectbox-1 form-control" value=""/>
                        </div>
                    </div>
                    ...
                    <div class="row show-grid ">
                        <div class="col-xs-4">
                            <label
                                class="control-label pull-right"><?php echo $CI->lang->line('INSTITUTE_MB_NUMBER'); ?></label>
                        </div>
                        <div class="col-sm-4 col-xs-8">
                            <input type="text" name="school_mobile_number" class="selectbox-1 form-control" value=""/>
                        </div>
                    </div>
