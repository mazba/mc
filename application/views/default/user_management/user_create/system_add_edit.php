...
<div id="system_content" class="system_content_margin">
    ...
    <form id="system_save_form" action="<?php echo $CI->get_encoded_url('user_management/User_create/index/save'); ?>"
          method="post">
        ...
        <div class="row widget">
            ...
            <div class="row show-grid">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('GROUP_NAME'); ?><span
            ...
            <div style="display: <?php echo $display_division; ?>" class="row show-grid " id="division_option">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('DIVISION_NAME'); ?><span
                            style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
            ...
            <div style="display: <?php echo $display_zilla; ?>" class="row show-grid " id="zilla_option">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('DISTRICT_NAME'); ?><span
                            style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
            ...
            <div style="display: <?php echo $display_upazila; ?>" class="row show-grid " id="upazila_option">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('UPAZILLA_NAME'); ?><span
                            style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
            ...
            <div style="display: <?php echo $display_unioun; ?>" class="row show-grid " id="union_option">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('UNION_NAME'); ?><span
                            style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
            ...
            <div style="display: <?php echo $display_city_corporation; ?>" class="row show-grid "
                 id="city_corporation_option">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('CITY_CORPORATION_NAME'); ?><span
                            style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
            ...
            <div style="display: <?php echo $display_city_corporation_ward; ?>" class="row show-grid "
                 id="city_corporation_ward_option">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('CITY_CORPORATION_WORD_NAME'); ?>
                        <span style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
                    <select name="user_detail[citycorporationward]" id="user_city_corporation_ward_id"
                            class="form-control">
                        <?php
            ...
            <div style="display: <?php echo $display_municipal; ?>" class="row show-grid " id="municipal_option">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('MUNICIPAL_NAME'); ?><span
                            style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
            ...
            <div style="display: <?php echo $display_municipal_ward; ?>" class="row show-grid "
                 id="municipal_ward_option">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('MUNICIPAL_WORD_NAME'); ?><span
                            style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
            ...
            <div style="" class="row show-grid " id="">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('USER_NAME'); ?><span
                            style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
                    <input type="text" name="user_detail[username]" class="form-control"
            ...
            <div style="" class="row show-grid " id="">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('EMAIL'); ?><span
                            style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
                    <input type="text" name="user_detail[email]" class="form-control"
            ...
            <div style="" class="row show-grid " id="">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('MOBILE_NUMBER'); ?><span
                            style="color:#FF0000">*</span></label>
                </div>
                <div class="col-sm-4 col-xs-8">
