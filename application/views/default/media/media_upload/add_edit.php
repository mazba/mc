        ...
        <div class="row widget">
            ...
            <div style="" class="row show-grid " >
                ...
                <div class="col-sm-4 col-xs-8">
                    <select name="media[media_type]" class="form-control validate[required] media_type">
            ...
            <div style="" class="row show-grid">
                ...
                <div class="col-md-7 col-xs-8">
                    <textarea style=" height: 200px" name="media[media_detail]" class="form-control textarea"><?php echo $MediaInfo['media_detail'];?></textarea>
                </div>
            </div>
            ...
            <div style="display: <?php if($MediaInfo['media_type']==3){echo 'show';}else{echo 'none';}?>;" class="row show-grid print_year">
                ...
                <div class="col-sm-4 col-xs-8">
                    <select name="media[print_year]" class="form-control validate[required]">
                        <option value=""><?php echo $CI->lang->line('SELECT');?></option>
                        <?php
                        $types = $CI->config->item('media_type');
                        $current_year = date('Y');
            ...
            <div style="" class="row show-grid">
                ...
                <div class="col-sm-4 col-xs-8">
                    <select name="media[status]" class="form-control validate[required]" id="module_options">
                        <?php
