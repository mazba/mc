...
<div id="system_content" class="system_content col-sm-12 text-center" style="margin-top: 5px;">
    ...
    <div class="system_content col-md-3 text-center">
        <div class="shadow curved-2 bg1caf9a">
			...
			<hr />
			<?php echo $this->lang->line('NUMBER_OF_PRIMARY_LEVEL');?>: <?php echo Dashboard_helper::bn2enNumber($general_institute_primary1); ?>
			<br />
			 <?php echo $this->lang->line('NUMBER_OF_SECONDARY_LEVEL');?>: <?php echo Dashboard_helper::bn2enNumber($general_institute_secondary1); ?>
			 <br />
			  <?php echo $this->lang->line('NUMBER_OF_INTERMEDIATE_LEVEL');?>: <?php echo Dashboard_helper::bn2enNumber($general_institute_intermediate1); ?>
        </div>
    </div>
    ...
    <div class="system_content col-md-3 text-center">
        <div class="shadow curved-2 bgd9534f">
           ...
           $general_primary_level=Dashboard_helper::get_mmc_use_general_level_wise('GENERAL','PRIMARY',$from_date,$to_date);
            ...
            <?php echo $this->lang->line('NUMBER_OF_PRIMARY_LEVEL');?>: <?php if($general_primary_level > 0) { echo System_helper::Get_Eng_to_Bng(number_format(($general_primary_level*100)/$general_institute_primary,2));} else echo '0'; ?> %<br />
