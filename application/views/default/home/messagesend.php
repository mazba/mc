...
<script type="text/javascript">
    ...
    {
        turn_off_triggers();
        var url = "<?php echo $CI->get_encoded_url('home/get_message_send');?>";
        ...
        $("#system_dataTable").jqxGrid(
            {
                ...
                columns: [
                    { text: '<?php echo $CI->lang->line('MESSAGE_RECEIVER'); ?>', dataField: 'name_en', width:'20%'},
                    { text: '<?php echo $CI->lang->line('COMMU_MESSAGE'); ?>', dataField: 'message', width:'60%'},
                    { text: '<?php echo $CI->lang->line('MESSAGE_DATE'); ?>', dataField: 'message_date', width:'20%'},
                ]
            });
