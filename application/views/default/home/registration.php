...
<div class="constant">
    <div class="row"  style="margin-top: 30px;">
        <div class="col-md-8 borderradius">
            <h3 style="text-align: left;padding-left: 15px;"><?php echo $this->lang->line('INSTITUTE_REGISTRATION');?></h3>
            <form id="registration_save_form" action="<?php echo $CI->get_encoded_url('home/registration'); ?>" method="post">
                <table width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td  width="35%">
                            <label class="control-label pull-left" style="margin-left: 30px;">   শিক্ষা প্রতিষ্ঠানের  স্তর     </label>
                            <br />
                            <br />
                            <?php
                            $dataa = array(
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            'id'            => 'mobile',
                            'class'            => 'form-control',
                            'placeholder'   => $this->lang->line('SCHOOL_MOBILE_PLACE'),
                            'size'          => '60',
                            );
                    ...
                    <tr>
                        <td style="margin-top: 20px;">
                            <label for="captcha" style=" display: block;margin: 0 auto;"><?php echo $captcha['image']; ?></label><br/>

                        <label class="control-label pull-left ">ক্যাপচা কোড<span style="color:#FF0000">*</span></label>
        ...
        <div class="col-md-4 ">
            <div class="control-group heloregistration">
                <h3 style="text-align: left;padding-left: 15px;">নিবন্ধনের নির্দেশাবলীঃ</h3>
                <ul>
                    <li>১ম ধাপঃ প্রথমে বিভাগ নির্বাচন করুন।</li>
                    <li>২য় ধাপঃ জেলা নির্বাচন করুন।।</li>
                    <li>৩য় ধাপঃ উপজেলা নির্বাচন করুন।</li>
                    <li>৪র্থ ধাপঃ শিক্ষা প্রতিষ্ঠানের  ধরন নির্বাচন করুন।</li>
                    <li>৫ম ধাপঃ শিক্ষা প্রতিষ্ঠানের  স্তর নির্বাচন করুন।।</li>
                    <li>৬ষ্ঠ ধাপঃ শিক্ষা প্রতিষ্ঠানের  নাম লিখুন।</li>
                    <li>৭ম ধাপঃ শিক্ষা প্রতিষ্ঠানের  ই-মেইল ঠিকানা লিখুন। এই <br />&nbsp;&nbsp;&nbsp;&nbsp;ই-মেইলটি  পরবর্তিতে ইউজার আইডি হিসাবে গণ্য হবে ।</li>
                    <li>৮ম ধাপঃ মোবাইল নম্বর লিখুন।</li>
                    <li>৯ম ধাপঃ শিক্ষা প্রতিষ্ঠানের EIIN নাম্বার লিখুন।</li>
                    <li>১০ম ধাপঃ পাসওয়ার্ড লিখুন।</li>
                    <li>১১তম  ধাপঃ "আবেদন করুন" এ ক্লিক করুন ।</li>
                </ul>
            </div>
        </div>
    </div>
