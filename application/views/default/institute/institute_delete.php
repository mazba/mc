...
<div id="system_content">
    ...
    <div id="system_content" class="dashboard-wrapper">
        <div class="grid_10">
            ...
            <form action="<?php echo $CI->get_encoded_url('institute/institute/index/delete_institute'); ?>" class="signup"
...
<script>
    function disable(id)
    {
        ...
        if(r==true)
        {
            ...
            $.ajax({
                type:"POST",
                url: '<?php echo $CI->get_encoded_url('institute/institute/deleteInstitute/'); ?>',
                data: 'id=' + id,
