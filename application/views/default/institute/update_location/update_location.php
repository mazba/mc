...
<div id="system_content" class="system_content_margin">
    <div id="system_action_button_container" class="system_action_button_container">
        <form id="graphclass" action="<?php echo $CI->get_encoded_url('institute_location_update/institute_location_update/index/update'); ?>" method="post">
                    ...
                    //     echo $result['id'].'<br />';
                        ...
                        if ($result['status']==2) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="<?php echo $CI->get_encoded_url('institute_location_update/institute_location_update/index/updateinfo/' . $result['id']); ?>"><?php echo $CI->lang->line('EDIT'); ?></a>
                                </td>
                            </tr>
                            <?php
                        }
