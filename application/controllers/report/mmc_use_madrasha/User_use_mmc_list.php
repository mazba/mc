...
class User_use_mmc_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/mmc_use_madrasha/user_use_mmc_list');
        //$this->controller_url='report/upload_report_model';
        $this->lang->load("report", $this->get_language());
        //$this->load->model("basic_setup/mmc_use_madrasha/user_use_mmc_list_model");
    }
    ...
    public function index()
    {
        ...
        $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("report/mmc_use_madrasha/user_use_mmc_list",$data,true));
        $ajax['system_page_url']=$this->get_encoded_url('report/mmc_use_madrasha/user_use_mmc_list');
