...
class Monthly_mmc_use_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/monthly/monthly_mmc_use_list');
        //$this->controller_url='report/upload_report_model';
        $this->lang->load("report", $this->get_language());
        //$this->load->model("basic_setup/monthly/monthly_mmc_use_list_model");
    }
    ...
    public function index()
    {
        ...
        $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("report/monthly/monthly_mmc_use_list",$data,true));
        $ajax['system_page_url']=$this->get_encoded_url('report/monthly/monthly_mmc_use_list');
