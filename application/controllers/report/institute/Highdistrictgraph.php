...
class Highdistrictgraph extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message = '';
        $this->permissions = Menu_helper::get_permission('report/institute/highdistrictgraph');
    ...
    //    $data['from_date']=$this->input->post('from_date');
     //   $data['to_date']=$this->input->post('to_date');
        ...
        $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("report/institute/highdistrictgraph","",true));
        $ajax['system_page_title']=$this->lang->line("WEBSITE_TITLE");
        $ajax['system_page_url'] = $this->get_encoded_url('report/institute/highdistrictgraph');
